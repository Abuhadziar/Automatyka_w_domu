...
fun SmartLightScreen(
    ...
    viewModel.setLightColor(viewModel.selectedConnectedDevice.value!!, command)
        ...
        Card(
            ...
            Row (
                ...
                androidx.compose.material3.Switch(
                    ...
                    onCheckedChange = {
                        status = it
                        viewModel.setLightColor(viewModel.selectedConnectedDevice.value!!, if (status) commandOn else commandOff)
                                      },
                    modifier = modifier
                        .padding(dimensionResource(R.dimen.padding_small))
                )
